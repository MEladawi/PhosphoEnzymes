...
| `kinhub_kinases.html` | KinHub human kinase list (kinhub.org; Eid et al. 2017) — **pinned, frozen snapshot** (not auto-fetched; committed to the repo for reproducibility) | http://www.kinhub.org/kinases.html (source of the snapshot) |

...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20732423.svg)](https://doi.org/10.5281/zenodo.20732423)

**A reproducible, substrate-aware reference of the human phosphorylation machinery — protein kinases and phosphatases — keyed on base Ensembl gene IDs and typed by what each enzyme acts on.**
...
get_kinases()         # 756 human kinases (556 act on protein)
get_phosphatases()    # 298 human phosphatases (181 act on protein)
...
The complete design rationale — every source, the identifier-resolution algorithm, the EC-subclass selection, the gate, and the QC gates — is documented in [`METHODOLOGY.md`](METHODOLOGY.md).

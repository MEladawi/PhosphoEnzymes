...
write_outputs <- function(kinases_table, unmapped_table, output_dir, source_manifest,
  ...
  readme_lines <- c(
    ...
    "  supplementary_support : go_experimental OR the reviewed UniProt kinase keyword. Splits",
    "                        Silver from Bronze among single-axis genes; never counts as an axis.",
    "  evidence_tier ....... practical prioritization heuristic over the two axes plus",
